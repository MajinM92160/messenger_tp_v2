 ...
 */
final class Version20221210202810 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, user_receiver_id INT DEFAULT NULL, user_sender_id INT DEFAULT NULL, content VARCHAR(255) NOT NULL, INDEX IDX_B6BD307F64482423 (user_receiver_id), INDEX IDX_B6BD307FF6C43E79 (user_sender_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
